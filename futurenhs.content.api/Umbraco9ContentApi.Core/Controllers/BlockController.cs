namespace Umbraco9ContentApi.Core.Controllers
{
    ...
    public sealed class BlockController : UmbracoApiController
    {
        ...
        public async Task<ActionResult> UpdateBlockAsync(Guid blockId, ContentModel blockModel, CancellationToken cancellationToken)
        {
            var result = await _futureNhsBlockHandler.UpdateBlockAsync(blockId, blockModel, cancellationToken);
